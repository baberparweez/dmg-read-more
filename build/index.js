...
const Edit = ({
  ...
  }), posts && posts.map(post => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Button, {
    key: post.id,
    onClick: () => onSelectPost(post)
  }, post.title.rendered)))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.RichText, {
    tagName: "p",
    className: "dmg-read-more",
    value: selectedPostTitle ? `Read More: <a href="${selectedPostPermalink}">${selectedPostTitle}</a>` : "",
    onChange: () => {}
  }));
};
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/dmg-read-more","version":"0.1.0","title":"DMG Read More","category":"widgets","icon":"smiley","description":"A WordPress plugin to provide users with a custom Gutenberg block that allows searching for posts.","attributes":{"selectedPostId":{"type":"number"},"selectedPostTitle":{"type":"string"},"selectedPostPermalink":{"type":"string"}},"supports":{"html":false},"textdomain":"dmg-read-more","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js"}');
